...
public class Rebbs {
	...
	public String toString() {
		return "Rebbs [rebbsid=" + this.rebbsid + ", usersid=" + this.usersid + ", bbsid=" + this.bbsid + ", contents="
				+ this.contents + ", addtime=" + this.addtime + ", username=" + this.username + ", title=" + this.title
				+ "]";
	}
